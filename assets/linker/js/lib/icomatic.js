var IcomaticUtils = (function () {
        return {
            fallbacks: [{
                from: 'roundedrectangleoutline',
                'to': '\ue043'
            }, {
                from: 'rectangleoutline',
                'to': '\ue040'
            }, {
                from: 'circleoutline',
                'to': '\ue015'
            ...
            run: function (force) {
                ...
                if (('WebkitFontFeatureSettings' in s) || ('MozFontFeatureSettings' in s) || ('MsFontFeatureSettings' in s) || ('OFontFeatureSettings' in s) || ('fontFeatureSettings' in s))
                    if (!force){
                        return;
                    }
